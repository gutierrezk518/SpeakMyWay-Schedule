    ...
    <section className="p-4 flex flex-col h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-grow">
        <Link href="/communication">
          <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center justify-center hover:bg-blue-50 active:bg-blue-100 transition-colors border-2 border-primary cursor-pointer">
        ...
        <Link href="/quick-mode">
          <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center justify-center hover:bg-purple-50 active:bg-purple-100 transition-colors border-2 border-secondary cursor-pointer">
        ...
        <Link href="/schedule">
          <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center justify-center hover:bg-green-50 active:bg-green-100 transition-colors border-2 border-accent cursor-pointer">
        ...
        <Link href="/customize">
          <div className="bg-white rounded-xl shadow-md p-6 flex flex-col items-center justify-center hover:bg-yellow-50 active:bg-yellow-100 transition-colors border-2 border-yellow-500 cursor-pointer">
