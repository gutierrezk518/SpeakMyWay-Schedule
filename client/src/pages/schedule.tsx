        ...
        <div className={`flex-grow ${isPortrait ? 'flex flex-col' : 'flex'} overflow-hidden`} style={{ flex: 1, overflow: 'hidden' }}>
          ...
          {!isFullscreen && (
            <div className={`${isPortrait ? 'w-full flex-grow' : 'w-2/3'} flex flex-col h-full`}>
              ...
              {/* Pagination at the bottom, not floating */}
              {totalPages > 1 && selectedCategory !== 'favorites' && (
                <div className="mt-4 mb-2 w-full flex justify-center">
                  <div className="p-2 border border-gray-200 flex justify-center space-x-2 bg-gray-50 shadow-md w-auto max-w-xs rounded-lg">
                    <button
