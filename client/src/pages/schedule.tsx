      ...
      <DragDropContext onDragStart={onDragStart} onDragEnd={onDragEnd}>
        <div className="flex-grow flex overflow-hidden">
          ...
          <div className={`${isFullscreen ? 'w-full' : 'w-1/2 border-r border-gray-200'} flex flex-col h-full`}>
            ...
            <div className="flex-grow p-3 bg-blue-50 flex flex-col">
              <Droppable droppableId="schedule">
                {(provided, snapshot) => (
                  <div
                    ref={provided.innerRef}
                    {...provided.droppableProps}
                    className={`overflow-y-auto flex-grow rounded-lg p-3 ${
                  ...
                  >
                    {currentSchedule.length === 0 ? (
                      <div className="text-center p-8 text-gray-500">
                        ...
                        <p className="font-medium">Drag activities here to build your schedule</p>
                      </div>
                    ) : (
